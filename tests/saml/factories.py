...
def build_sp_metadata(entity_id, acs_url, key_file=None, cert_file=None, encryption_cert_file=None):
    ...
    which is the metadata signal that drives the IdP to encrypt the assertion to that SP.
    """
